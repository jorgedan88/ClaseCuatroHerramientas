...
namespace ClaseCuatroHerramientas.Services;
    ...
    public static class MovieService{
        ...
        static MovieService(){
            ...
            new Movie { Name = "Avatar", Code = "AVT", Category = "Sci fi", Minutes = 500, Review = "Puede aparecer la reseña"} ,
            ...
            new Movie { Name = "Esperando la carroza", Code = "ELC", Category = "Sci fi", Minutes = 500, Review = "No aparece la reseña"} ,
            ...
            new Movie { Name = "El padrino", Code = "ELP", Category = "Accion", Minutes = 500, Review = "Aparece la reseña"} ,
